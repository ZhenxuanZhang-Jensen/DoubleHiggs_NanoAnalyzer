...
void WVJJData::init() {
  ...
  fTree->Branch("GEN_Ele_p",&GEN_Ele_p,"GEN_Ele_p/F");
  fTree->Branch("GEN_Ele_pt",&GEN_Ele_pt,"GEN_Ele_pt/F");
  fTree->Branch("GEN_Ele_pz",&GEN_Ele_pz,"GEN_Ele_pz/F");
  fTree->Branch("GEN_Ele_eta",&GEN_Ele_eta,"GEN_Ele_eta/F");
  fTree->Branch("GEN_Ele_phi",&GEN_Ele_phi,"GEN_Ele_phi/F");
  fTree->Branch("GEN_Ele_m",&GEN_Ele_m,"GEN_Ele_m/F");
  fTree->Branch("GEN_Ele_E",&GEN_Ele_E,"GEN_Ele_E/F");
  fTree->Branch("GEN_Muon_p",&GEN_Muon_p,"GEN_Muon_p/F");
  fTree->Branch("GEN_Muon_pt",&GEN_Muon_pt,"GEN_Muon_pt/F");
  fTree->Branch("GEN_Muon_pz",&GEN_Muon_pz,"GEN_Muon_pz/F");
  fTree->Branch("GEN_Muon_eta",&GEN_Muon_eta,"GEN_Muon_eta/F");
  fTree->Branch("GEN_Muon_phi",&GEN_Muon_phi,"GEN_Muon_phi/F");
  fTree->Branch("GEN_Muon_m",&GEN_Muon_m,"GEN_Muon_m/F");
  fTree->Branch("GEN_Muon_E",&GEN_Muon_E,"GEN_Muon_E/F");
  fTree->Branch("Ele_p",&Ele_p,"Ele_p/F");
  fTree->Branch("Ele_pt",&Ele_pt,"Ele_pt/F");
  fTree->Branch("Ele_pz",&Ele_pz,"Ele_pz/F");
  fTree->Branch("Ele_eta",&Ele_eta,"Ele_eta/F");
  fTree->Branch("Ele_phi",&Ele_phi,"Ele_phi/F");
  fTree->Branch("Ele_m",&Ele_m,"Ele_m/F");
  fTree->Branch("Ele_E",&Ele_E,"Ele_E/F");
  fTree->Branch("Muon_p",&Muon_p,"Muon_p/F");
  fTree->Branch("Muon_pt",&Muon_pt,"Muon_pt/F");
  fTree->Branch("Muon_pz",&Muon_pz,"Muon_pz/F");
  fTree->Branch("Muon_eta",&Muon_eta,"Muon_eta/F");
  fTree->Branch("Muon_phi",&Muon_phi,"Muon_phi/F");
  fTree->Branch("Muon_m",&Muon_m,"Muon_m/F");
  fTree->Branch("Muon_E",&Muon_E,"Muon_E/F");
